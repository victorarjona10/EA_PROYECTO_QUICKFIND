...
export declare class NotificationService {
    ...
    getUserNotifications(userId: string, limit?: number, offset?: number, onlyUnread?: boolean): Promise<(mongoose.Document<unknown, {}, import("../models/notification").INotification, {}> & import("../models/notification").INotification & Required<{
